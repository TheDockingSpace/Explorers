...
/**
  * This is an event sourced entity. It has a state, [[ExplorersState]], which
  ...
  */
class ExplorersEntity extends PersistentEntity {

  override type Command = ExplorersCommand[_]
  override type Event = ExplorersEvent
  override type State = ExplorersState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: ExplorersState = ExplorersState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case ExplorersState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        ExplorersState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class ExplorersState(message: String, timestamp: String)

object ExplorersState {
  /**
    ...
    */
  implicit val format: Format[ExplorersState] = Json.format
}

/**
  * This interface defines all the events that the ExplorersEntity supports.
  */
sealed trait ExplorersEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends ExplorersEvent
...
/**
  ...
  */
sealed trait ExplorersCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends ExplorersCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends ExplorersCommand[String]
